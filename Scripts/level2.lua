...
local dialog_msgs = {
  ...
  [3] = {"Ahah! I see. <br> Well, that is not surprising, Ikani... Almost no one has ever laid eyes on one of those.","Matak High-Preacher", 1741, 0, 225},
  ...
  [5] = {"Farewell, shaman! Remember, the orb will test your wisdom... For every decision, there will be a reward - but in each reward lies a sacrifice... <br> I must go now, for i promised to show the location of this orb to the other shamans of this land. ","Matak High-Preacher", 1742, 0, 225},
